...
import { type HospitalUser } from "@/types/auth";

type RegistrationStep = "language" | "hospital" | "verification" | "complete";
...
export default function HospitalRegister() {
  ...
  const [formData, setFormData] = useState({
    ...
    address: "",
    adminRole: "admin" as "admin" | "staff" | "receptionist",
  });
  ...
  const steps = [
    ...
    { id: "hospital", label: "Hospital Info", completed: ["verification", "complete"].includes(step) },
    { id: "verification", label: "Verify", completed: step === "complete" },
  ];

  const handleLanguageSelect = (lang: LanguageCode) => {
    setSelectedLanguage(lang);
    setTimeout(() => setStep("hospital"), 300);
  };

  const handleHospitalSubmit = () => {
    if (!formData.name || !formData.phone || !formData.email || 
        !formData.hospitalRegistrationNumber || !formData.address) {
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, hospitalRegistrationNumber: e.target.value })}
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-4 py-3 border-2 border-border rounded-lg focus:border-primary focus:outline-none bg-surface text-foreground resize-none"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-foreground mb-2">
              ...
              <div className="grid grid-cols-3 gap-3">
                {["admin", "staff", "receptionist"].map((role) => (
                  <button
                    key={role}
                    onClick={() => setFormData({ ...formData, adminRole: role as any })}
            ...
            <Button onClick={handleHospitalSubmit} className="w-full bg-primary">
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="bg-surface border-b border-border">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <button
            onClick={() => router.push("/auth/hospital/login")}
